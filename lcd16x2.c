...
void LCD_Send4Bit(unsigned char Data)//gui lenh 4bit
{
...
void LCD_Clear()
{
  LCD_SendCommand(0x01);//xoa tat ca tren man
  DelayUs(10);
}
...
//	LCD_SendCommand(0x18); // dich trai toan bo khung hinh
//	LCD_SendCommand(0x1C); // dich phai toan bo khung hinh
...
void LCD_PutChar(unsigned char Data)//tung ki tu
{
...
void LCD_Puts(char *s)// chuoi ki tu
{
  while (*s)
  {
    LCD_PutChar(*s);
